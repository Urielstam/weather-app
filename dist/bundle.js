    ...
    searchForm.addEventListener("submit", (e) => {
        ...
        details.then((result) => {
            if (result.temp) {
                ...
                timeOfCityParam.textContent = _utils__WEBPACK_IMPORTED_MODULE_1__.utils.formatDate(result.date);
                ...
                let dailyForecast = _apiFunctions__WEBPACK_IMPORTED_MODULE_0__.dataFetcher.fetchCityForecast(
                    result.lat,
                    result.lon
                );
                dailyForecast.then((forecast) => {
                    if (forecast) {
                        ...
                        for (let element of arr) {
                            ...
                            let minMaxValues = _utils__WEBPACK_IMPORTED_MODULE_1__.utils.getDailyValues(forecast);
                            let paragraphs = element.getElementsByTagName("p");
                            let day = paragraphs[0];
                            let highTemp = paragraphs[1];
                            let lowTemp = paragraphs[2];
                            day.textContent = _utils__WEBPACK_IMPORTED_MODULE_1__.utils.formatDate(minMaxValues[0][index])
                                .split(" ")
                                .splice(0, 2)
                                .join(" ");
...
const utils = (() => {
    const formatDate = (timestamp) => {
        ...
        const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(date, "eee d MMMM yyyy h:mm a");
